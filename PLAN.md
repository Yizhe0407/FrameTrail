...
目前基準為 17 個測試檔、64 項測試全部通過，TypeScript compile、Chrome MV3 build 與 Firefox MV2 build 皆通過。測試覆蓋：
...
實際 Chrome E2E 另驗證 nested/cross-origin/rotated iframe、iframe 內 disabled control、SVG、canvas、custom element、image map、同元素去重、Dialog，以及編輯器複製/刪除/拖曳零閃爍。

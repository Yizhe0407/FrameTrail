...
- `extension/lib/db.ts`：v4 schema、Guide／章節與混合 `StepEntry` 模型、legacy salvage、原子結構修改與 annotation 契約；`manualBounds`、owner-level `redactions`、`captureRevision`、補拍替換與 conflict guard。

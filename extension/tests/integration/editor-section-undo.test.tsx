...
// The editor renders controls (UndoSnackbar, EditorHeader, ...) that use the
// shadcn Tooltip, which requires a TooltipProvider ancestor — wrap every
// render() the same way the app roots do.

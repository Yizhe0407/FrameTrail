...
- `pnpm test`：一次執行上述 21 個 Vitest 測試檔、99 項測試。
- `pnpm test:e2e`：建立 Chrome MV3 production 版本並執行 6 個 Playwright spec、28 項 Chromium E2E。
- `pnpm test:all`：依序執行 99 項 Vitest 與 28 項 E2E。
